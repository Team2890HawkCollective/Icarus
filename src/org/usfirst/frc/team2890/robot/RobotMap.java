...
public class RobotMap 
{
	...
	public static void init()
	{
		...
		//timedDriveForwardAutonomousCommand = new AutonomousTimedDriveForward(driveStraightTimeDrive);
		//rotationAutonomous = new AutonomousRotateIntCommand(rightTurnDegrees);
