 ...
 *
 */
public class MegaAutonomousCommandModeGroupRightToLeft extends CommandGroup {

    public MegaAutonomousCommandModeGroupRightToLeft() {
    	
    	//addSequential(new ClawDownCommand());
    	addSequential(new AutonomousTimedDriveForward(7));
